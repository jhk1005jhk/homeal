...
router.put('/', isAuthenticated, function(req, res, next) {
    ...
    Reservation.updateReservation(data, function (err, result) {
        ...
        switch (parseInt(data.status)) {
            case 2: message = '예약이 승인 완료 되었습니다'; code = 2; break; // 쿠커가 잇터의 예약을 승안
            case 3: message = '예약이 거절 완료 되었습니다'; code = 3; break; // 쿠커가 잇터의 예약을 거절
            ...
            case 7: message = '식사가 완료 되었습니다'; code = 7; break;     // 잇터가 후기를 작성하면 식사 완료 상태로 변경
        }
        res.send({
            code: code,
            message: message
